...
def evaluate_route(instance: Instance, route: Route) -> Tuple[float, float, float]:
...
def evaluate_solution(instance: Instance, routes: Iterable[Route], penalty_tw: float) -> Solution:
    ...
    for route in solution.routes:
        distance, timewarp, load = evaluate_route(instance, route)
